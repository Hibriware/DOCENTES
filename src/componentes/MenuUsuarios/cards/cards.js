    ...
    return (
        <>
            <Card elevation={5} style={{
                ...
                width: 400,
                textAlign: 'center',
                backgroundImage: "url(" + StoreImg[Math.floor(Math.random() * (4 - 0)) + 0].n + ")"
                ...
                <CardActions>
                    <Button size="small">Semestre: "{semestre} {grupo}"</Button> <Button
                    style={{marginInlineStart: 'auto'}} size="small"><Link to="/Docente">Iniciar</Link></Button>
                </CardActions>
            </Card>
        </>
    );
